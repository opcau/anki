...
var ojDialogMeta = {
  ...
  "extension": {
    "_hasWrapper": true,
    "_innerElement": 'div',
    "_widgetName": "ojDialog"
  }
};
oj.Components.registerMetadata('ojDialog', 'baseComponent', ojDialogMeta);
oj.Components.register('oj-dialog', oj.Components.getMetadata('ojDialog'));
})();
});
